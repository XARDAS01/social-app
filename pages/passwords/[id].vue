<template>
  <section class="pass-card">
    <div class="pass-card__wrapper" v-if="service">
      <div class="card__wrapper__header header">
      ...
      <div class="card__wrapper__body body">
        <p class="body__login">
          {{ service.login }}
        </p>
        <p>
...
const serviceStore = usePasswordsStore();
var service = reactive(serviceStore.getServiceList.filter(service => service.id == useRoute().params.id)[0]);
